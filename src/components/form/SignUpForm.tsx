...
import { Button, Loader, InputField } from "@/components/elements";
export const SignUpForm = () => {
  ...
  return (
    <>
      ...
      <div className="max-w-[90%] border-transparent rounded-[20px] bg-[#161d2f] w-96 h-100 px-8 py-6 ">
        <h2 className="text-white text-3xl font-extralight">Sign Up</h2>

        <form
          className="flex flex-col justify-center items-start"
          onSubmit={handleSubmit}>
          <div className="w-full bg-[#161d2f] mt-4">
            <InputField
              id="firstName"
              type="text"
              name="firstName"
          ...
          <div className="w-full bg-[#161d2f] mt-4 relative">
            <InputField
              id="password"
